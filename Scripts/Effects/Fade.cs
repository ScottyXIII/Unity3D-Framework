...
{   
	private static Fade mInstance = null;
	...
	private static Fade instance
	{
		get
		{
			if( mInstance == null )
			{
				mInstance = GameObject.FindObjectOfType(typeof(Fade)) as Fade;
	
				mInstance = new GameObject("Fade").AddComponent<Fade>();
			}
